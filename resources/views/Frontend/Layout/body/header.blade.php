    ...
    <div class="col-lg-12 menu-small-screen">
        ...
        <div class="offcanvas offcanvas-start mobile_menu_offcanvas" tabindex="-1"
            ...
            <div class="offcanvas-header">
                <div class="nav-logo">
                    <img src="{{ asset('frontend/assets/image/1x/Asset 9.png') }}" alt="">
                </div>
            ...
            <div class="offcanvas-body">
                <div class="menus-offcanvas">
                    <ul class="">
                        <li>
                            <div class="dropdown">
                                <button class="dropbtn"><a href="{{ route('home') }}">Home</a>
                                </button>
                            </div>
                        </li>
                        <li>
                            <div class="dropdown">
                                <button class="dropbtn"><a href="{{ route('about-amea') }}">About AMEA</a>
                                </button>
                            </div>
                        </li>
                        <li>
                            <div class="dropdown">
                                <button class="dropbtn"><a href="{{ route('Band-Room') }}">Student Brand Room</a>
                                </button>
                            </div>
                        </li>
                        <li>
