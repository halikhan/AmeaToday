...
<div class="main-div Band-Room-img">
    <div class="private-inst">
        ...
        <div class="container">
            <?php $__currentLoopData = $getBandRoom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <div class="first-section card-type-back-color wow bounceIn">
                <div>
                    
                    <h1 class=""><?php echo e($data->title); ?></h1>
                </div>
                 <div class="for-width-p for-mobile-display mt4"><?php echo $data->content; ?></div>
...
<?php echo $__env->make('Frontend.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Amea_Today\resources\views/Frontend/Band-Room.blade.php ENDPATH**/ ?>