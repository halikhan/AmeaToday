                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="last_name" class="form-control btn-square" id="exampleFormControlInput10" type="text" value="<?php echo e($edit_data->last_name); ?>" placeholder="Last Name">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput10">Adress.*</label>
                                <input name="address" class="form-control btn-square"  value="<?php echo e($edit_data->address); ?>" id="exampleFormControlInput10" type="text" placeholder="Adress">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="contact" class="form-control btn-square"  value="<?php echo e($edit_data->contact); ?>" id="exampleFormControlInput10" type="text" placeholder="contact">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <select name="type" class="form-select" size="1">
                                    ...
                                    <option value="2" <?php echo e($edit_data->type == '2' ? 'selected' : ''); ?>>Student</option>
                                    <option value="3"<?php echo e($edit_data->type == '3' ? 'selected' : ''); ?>>Coach</option>
                                    <option value="4"<?php echo e($edit_data->type == '4' ? 'selected' : ''); ?>>Evaluator</option>
                                 </select>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Amea_Today\resources\views/users/edit.blade.php ENDPATH**/ ?>