                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="email" class="form-control btn-square"  value="<?php echo e($edit_data->email); ?>" id="exampleFormControlInput10" type="email" placeholder="Email">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Amea_Today\resources\views/admin/edit.blade.php ENDPATH**/ ?>