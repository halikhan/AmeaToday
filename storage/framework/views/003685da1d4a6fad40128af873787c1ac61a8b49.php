                        ...
                        <?php $__currentLoopData = $getCoaches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><a class="btn btn-success" type="button"
                                        href="<?php echo e(route('AmeaToday', $value->id)); ?>">Select</a></td>
                            </tr>
                        ...
                        <div class="main-tabs-card">
                            <div class="tabs-card-content">
                                ...
                                <div class="tabs-card-title-content">
                                    ...
                                    <a href="<?php echo e(route('coach_profile')); ?>" class="read-more-btn">Read More <i
                        ...
                        <div class="main-tabs-card">
                            <div class="tabs-card-content">
                                ...
                                <div class="tabs-card-title-content">
                                    <p>Whatever tattooed stumptown art party sriracha gentrify hashtag intelligentsia
                                        readymade schlitz brooklyn disrupt.</p>
                                    <a href="./profile.blade.php" class="read-more-btn">Read More <i
                                            class="fa fa-angle-right icone-padding-left" aria-hidden="true"></i><i
                                            class="fa fa-angle-right icone-padding-left" aria-hidden="true"></i></a>
                                </div>
                            </div>
