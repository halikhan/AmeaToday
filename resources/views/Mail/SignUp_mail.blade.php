                ...
                <tr>
                  <td>
                    <table style="width: 650px; margin: 0 auto; margin-bottom: 30px">
                      <tbody>
                        <tr>
                          <td><img src="{{ asset('storage/uploads/logo/'.$logo_add->image) }}" alt=""></td>
                        </tr>
                      </tbody>
                    </table>
                    <table style="width: 650px; margin: 0 auto; background-color: #fff; border-radius: 8px">
                      <tbody>
                        <tr>
                            <td style="width: 650px; margin: 0 auto; margin-bottom: 30px"><img src="{{ asset('storage/uploads/logo/'.$logo_add->image) }}" alt=""></td>
                          </tr>
                        <tr>
                          <td style="padding: 30px">
                           ...
                           <b>@if ($type==2 )Student
                            @elseif ($type==3 )Coach
                            @elseif ($type==4 )Evaluator
                            @endif to Amea Today</b> </p>
                      ...
                      <tbody>
                        <tr style="text-align: center">
                          <td>
                            ...
                            <p style="color: #999; margin-bottom: 0"><span>{{ $Copyright->email_one }}</span></p>
                            @endforeach
