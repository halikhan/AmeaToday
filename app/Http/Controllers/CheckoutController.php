...
class CheckoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // return redirect()->route('AmeaToday_buy-now')->with($notification);
    ...
    public function StorePaymentDetails(Request $request)
    {
        ...
        // session()->put('User_Signup', $arr);
        // session()->get('User_Signup')['user_id'],
    ...
    //    dd($userdertails->id);
        ...
        // if (session()->get('User_Signup')['email'] && session()->get('User_Signup')['password']) {
