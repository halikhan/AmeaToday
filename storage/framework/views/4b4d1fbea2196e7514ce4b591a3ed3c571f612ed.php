    ...
    <div class="main-div background-grey-color">
        <div class="home-page">
            <div class="top-home-section">
                ...
                <?php $__currentLoopData = $getPiyano; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getPiyano): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="video-box">
                        <video id="background-video" autoplay loop muted>
                            <source src="<?php echo e(asset('storage/uploads/video/' . $getPiyano->video)); ?>" type="video/mp4">
                        </video>
                    </div>
                ...
                <div data-wow-delay="0.50s" class="video-content-center wow fadeIn">
                    ...
                    <?php $__currentLoopData = $getahomeMainHeading; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $MainHeading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <h2> <?php echo $MainHeading->title; ?></h2>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php $__currentLoopData = $getBackAudio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Audio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <audio controls id="mp3Player" hidden>
                        <!-- change song here -->
                        <source src="<?php echo e(asset('storage/uploads/audio/' . $Audio->audio)); ?>" type="audio/mpeg">
                    </audio>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="first-section">
                ...
                <div class="swiper mySwiper mt3">
                    <div class="swiper-wrapper">
                        <?php $__currentLoopData = $getSponsors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Sponsors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="swiper-slide cstm-width">
                                <div class="first-section-slider-img ">
                                    <img src="<?php echo e(asset('storage/uploads/cms/' . $Sponsors->image)); ?>" alt="slider">
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
            ...
            <div class="container">
                ...
                <div class="second-section">
                    <?php $__currentLoopData = $getMusic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="player-size mt3 wow bounceIn">
                        ...
                        <div id="set_image" class="player-wrap track-view light"
                            ...
                            data-artist="Mythium"
                            style="background-image: url('<?php echo e(asset('storage/uploads/audio/' . $getAudio[0]['image'])); ?>');">
                            <audio preload></audio>
                            <div class="for-mobile-screen-background">
                                <img src="<?php echo e(asset('frontend/assets/image/1x/paly-music.png')); ?>" alt="">
                            </div>
                            <div class="player">
                            ...
                            <div id="songs-palylist"class="playlist-wrap">
                                 <h2><?php echo e($getAudio[0]['title']); ?></h2>
                                <ol>
                                    <?php $__currentLoopData = $getAudio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $Audio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li data-img="<?php echo e($Audio->image); ?>">
                                            <a href="<?php echo e(asset('storage/uploads/audio/' . $Audio->audio)); ?>"
                                                data-artist="track <?php echo e($key + 1); ?>"><?php echo e($Audio->content); ?></a>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ol>
                            </div>
                ...
                <div class="third-section mt5">
                    <?php $__currentLoopData = $getahomeQuote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="third-sec-heading mt2">
                            <h2 class="wow fadeInLeft"><?php echo $Quote->content; ?></h2>
                        </div>
                        <div class="third-sec-heading mt3">
                            <h2 class="wow fadeInLeft for-decres-size"><?php echo e($Quote->title); ?></h2>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div id="example" class="mt3 for-height-fix">
                        <carousel-3d :autoplay="true" :autoplay-timeout="3000"  :clickable="true">
                            <?php $__currentLoopData = $getGallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $Gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <slide :index="<?php echo e($key ++); ?>">
                                
                                    <img src="<?php echo e(asset('storage/uploads/cms/' . $Gallery->image)); ?>" alt="slidermedium">
                                </slide>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </carousel-3d>
                ...
                <?php $__currentLoopData = $getahome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $home): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div data-wow-delay="0.40s" class="mt5">
                        ...
                        <div data-wow-delay="0.40s" class="fouth-sec-para mt3 wow bounceIn">
                            ...
                            <a class="" href="<?php echo e(route('about-amea')); ?>"><button
            ...
            <div>
                <?php $__currentLoopData = $getGuitar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Guitar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div data-wow-delay="0.60s" class="fifth-section fourth-section wow bounceIn">
                        <div class="video-box2 mt6">
                            <video id="background-video" autoplay loop muted>
                                <source src="<?php echo e(asset('storage/uploads/video/' . $Guitar->video)); ?>" type="video/mp4">
                            </video>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            $("#songs-palylist li").click(function() {
                var path = "<?php echo e(asset('storage/uploads/audio/')); ?>/" + $(this).attr('data-img');
                $("#set_image").css("background-image", "url( " + path + "  )");

                var path2 = "<?php echo e(asset('storage/uploads/audio/')); ?>/" + $(this).attr('data-img');
...
<?php echo $__env->make('Frontend.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Amea_Today\resources\views/home.blade.php ENDPATH**/ ?>