...
<body>
    ...
    <script src="{{ asset('frontend/assets/cdn/jquery2.js') }}"></script>
    <script src="{{ asset('frontend/assets/cdn/jquery3.js') }}"></script>
    ...
    <script src="{{ asset('frontend/assets/cdn/animated.js') }}"></script>
    <script src="{{ asset('frontend/assets/main.js') }}"></script>
    <script src="{{ asset('frontend/assets/cdn/bootstrap.min.js') }}"></script>
