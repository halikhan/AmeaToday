                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="amount" class="form-control btn-square"  id="exampleFormControlInput10" type="text" value="<?php echo e($edit_data->amount); ?>" placeholder="amount">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <?php $__errorArgs = ['deatails'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="help-block" style="color: red">
                                        <?php echo e($errors->first('deatails')); ?>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Amea_Today\resources\views/Package/edit.blade.php ENDPATH**/ ?>