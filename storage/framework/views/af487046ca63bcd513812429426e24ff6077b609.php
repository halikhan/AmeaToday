...
<div class="main-div prvt-vocal-img">
    <div class="private-inst">
        ...
        <div class="container">
            <?php $__currentLoopData = $getprivateVocal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('Frontend.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Amea_Today\resources\views/Frontend/private-vocal.blade.php ENDPATH**/ ?>